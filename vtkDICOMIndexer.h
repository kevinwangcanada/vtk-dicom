...
=========================================================================*/
#ifndef __vtkDICOMIndexer_h
#define __vtkDICOMIndexer_h
 ...
 *  index the files and frames in the series so that they can be arranged
 *  as a multi-dimensional volume.  
 */
class VTK_DICOM_EXPORT vtkDICOMIndexer : public vtkObject
{
public:
  vtkTypeMacro(vtkDICOMIndexer,vtkObject);
  void PrintSelf(ostream& os, vtkIndent indent);
  static vtkDICOMIndexer *New();
...
private:
  vtkDICOMIndexer(const vtkDICOMIndexer&);  // Not implemented.
  void operator=(const vtkDICOMIndexer&);  // Not implemented.
